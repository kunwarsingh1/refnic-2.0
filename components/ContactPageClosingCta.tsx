  ...
  return (
    <section className="relative overflow-hidden bg-black py-24 md:py-32">
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-6 text-center">
        <h2 className="whitespace-pre-line font-display text-3xl md:text-5xl font-bold leading-tight text-[#F8F8F8]">
          {heading}
        </h2>
        ...
        <div className="mx-auto mt-8 flex justify-center">
          {imageUrl ? (
            ...
            <img src={imageUrl} alt="" className="h-56 w-full max-w-md rounded-lg object-contain" />
          ) : (
        ...
        <p className="mx-auto mt-4 max-w-2xl whitespace-pre-line text-[21.64px] leading-[32.46px] text-white">{body}</p>
