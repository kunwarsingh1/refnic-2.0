...
export default function ResourceItemHero({ heading, body }: { heading: string; body: string }) {
  return (
    <section className="relative overflow-hidden bg-black pb-16 pt-28 md:pb-20 md:pt-36">
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 text-center">
        ...
        <p className="mx-auto mt-8 max-w-xl whitespace-pre-line text-[20.46px] leading-[30.69px] text-white">{body}</p>
