  ...
  return (
    <div className="relative z-10 mx-auto max-w-6xl px-6">
      <div className="rounded-2xl bg-[#F8F8F8] px-6 py-10 text-[#050505] md:px-14 md:py-16">
        ...
        <div className="mt-12">
          {cs.imageUrl ? (
            <img src={cs.imageUrl} alt={cs.label} className="h-auto w-full rounded-xl" />
          ) : (
          ...
          <div className="mt-16 flex flex-col gap-6 md:flex-row md:items-start md:justify-between md:gap-10">
            <div className="md:max-w-[220px]">
              ...
              {cs.overviewSubheading && (
                <p className="mt-4 whitespace-pre-line font-display text-[28px] font-light leading-[31.64px] text-[#050505]">
                  {cs.overviewSubheading}
                </p>
              )}
            </div>
        ...
        <div className="mt-12">
          {cs.imageUrl2 ? (
            <img src={cs.imageUrl2} alt="" className="h-auto w-full rounded-xl" />
          ) : (
            <CmsImagePlaceholder className="aspect-[1324/681] w-full rounded-xl" />
          )}
        </div>
          ...
          <div className="mt-16">
            ...
            <div className="mt-8 flex flex-col gap-6 md:flex-row md:items-start md:justify-between md:gap-10">
              {cs.approachSubheading && (
                <p className="max-w-sm whitespace-pre-line font-display text-[28px] font-light leading-[31.64px] text-[#050505]">
                  {cs.approachSubheading}
                </p>
              )}
              {cs.approachBody && (
            ...
            {cs.approachSecondaryHeading && (
              <p className="mt-12 whitespace-pre-line text-right font-display text-[36px] font-light leading-[40.68px] text-[#050505]">
                {cs.approachSecondaryHeading}
              </p>
            )}
            ...
            {(cs.approachIntro || cs.approachBullets.length > 0) && (
              <div className="mt-8 max-w-3xl">
                {cs.approachIntro && (
                  <p className="whitespace-pre-line text-[18px] leading-[32.46px] text-[#050505]">
                    {cs.approachIntro}
                  </p>
                )}
        ...
        {cs.tagline && (
          <p className="mt-16 max-w-2xl whitespace-pre-line text-[21.64px] leading-[32.46px] text-[#030303]">
            {cs.tagline}
          </p>
        )}
      </div>
