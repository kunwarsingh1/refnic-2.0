  ...
  return (
    <section className="relative overflow-hidden bg-black py-16 md:py-24">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6">
        {heading && (
          <h2 className="whitespace-pre-line text-center font-display text-[40px] font-normal uppercase leading-tight text-[#EBEBEB]">
            {heading}
          </h2>
        )}
          ...
          {materials.map((m) => (
            <div key={m.title} className="relative">
              ...
              <div className="relative flex flex-col p-5">
                <h3 className="whitespace-pre-line font-display text-[18px] font-normal leading-tight text-[#EBEBEB]">
                  {m.title}
                </h3>
                <div className="relative mt-4">
                  ...
                  {m.imageUrl ? (
                    ...
                    <img src={m.imageUrl} alt="" className="relative aspect-[4/3] w-full rounded-xl object-contain" />
                  ) : (
                    <CmsImagePlaceholder className="relative aspect-[4/3] w-full rounded-xl" />
                  )}
                </div>
                <p className="mt-2 flex-1 whitespace-pre-line text-sm leading-relaxed text-white/55">{m.body}</p>
              </div>
            </div>
          ))}
        </div>
