    ...
    <footer className="relative bg-black">
      <div className="relative">
        ...
        <div className="relative h-[9.5vw] md:h-[90px]">
         <p
  className="pointer-events-none absolute inset-x-0 -top-8 select-none whitespace-nowrap text-center font-display font-black leading-none  drop-shadow-[0_0_25px_rgba(255,255,255,0.35)] text-[19vw] md:text-[9rem]"
  aria-hidden
  style={{
