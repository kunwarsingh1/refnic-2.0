...
export default async function AdminWhitePapersPagePage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-white">White Papers Page</h1>
      <p className="mt-1 text-sm text-white/50">Controls the /white-papers page hero and closing CTA.</p>
